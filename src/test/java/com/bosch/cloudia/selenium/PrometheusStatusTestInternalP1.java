/**
 * PrometheusStatusTestInternalP1.java
 *
...
/**
 * This testcase opens Prometheus Internal Url and checks for the Target Status
 ...
 */
public class PrometheusStatusTestInternalP1 {
	private String url;
	...
	public void prometheusStatusTest() {
		...
		/**
		 * Step 1 and 2: Checks the prometheus-internal-url and verifies no unhealthy
		 * targets are present.
		 */
		initializeProperties("prometheus.internal.url");
