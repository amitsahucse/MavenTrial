/**
 * PrometheusStatusTestDevopsP1.java
 *
...
/**
 * This testcase opens Prometheus Devops Url and checks for the Target Status should not be unhealthy.
 *
 * @author Amit Kumar Sahu (amit-kumar.sahu@lhind.dlh.de)
 * @author Tobias Mahncke (tobias.mahncke@lhind.dlh.de)
 */
public class PrometheusStatusTestDevopsP1 {
    private String url;
    ...
    public void prometheusStatusTest() {
		...
		/**
		 * Step 1 and 2: Checks the prometheus-devops-url and verifies no unhealthy targets are present.
		 */
		initializeProperties("prometheus.devops.url");
    ...
    /**
     * This method clicks on status and then Targets, and verifies no unhealthy targets are present.
     */
